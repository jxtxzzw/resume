<template>
  <div>
    ...
    >
      <img
        v-if="item.fired === '1' && item.fired_photo"
        slot="cover"
        :alt="item.name"
        :src="setting.src.food + item.fired_photo"
      />
      <template slot="actions" class="ant-card-actions">
        <a-popover v-if="item.seen === '1'">
        ...
        <a-icon v-if="item.seen === '0'" type="eye" />
        <a-popover v-if="item.ate === '1'">
          <template slot="content">
        ...
        <a-icon v-if="item.ate === '0'" type="shopping" />
        <a-popover v-if="item.fired === '1'">
          <template slot="content">
        ...
        <a-icon v-if="item.fired === '0'" type="fire" />
      </template>
